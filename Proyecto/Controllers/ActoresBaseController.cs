...
{
    [ApiController]
    [Route("api/actoresBase")]
    public class ActoresBaseController: CustomBaseController
    {
        private readonly ApplicationDbContext context;
        private readonly IMapper mapper;
        private readonly IAlmacenadorArchivos almacenadorArchivos;
        private readonly string contenedor = "actores";
        public ActoresBaseController(ApplicationDbContext context, IMapper mapper) : base(context, mapper)  
        {
